...
//    }
    ...
    FLOATX_ATTRIBUTES floatx(const float other) noexcept
        : detail::floatx_base<floatx>(backend_float(other))
    {
        this->initialize();
    }

    FLOATX_ATTRIBUTES floatx(const int other) noexcept
        : detail::floatx_base<floatx>(backend_float(other))
    {
        this->initialize();
    }

    FLOATX_ATTRIBUTES floatx(const double other) noexcept
        : detail::floatx_base<floatx>(backend_float(other))
    {
        this->initialize();
    }

    FLOATX_ATTRIBUTES floatx(const size_t other) noexcept
        : detail::floatx_base<floatx>(backend_float(other))
    {
        this->initialize();
    }
