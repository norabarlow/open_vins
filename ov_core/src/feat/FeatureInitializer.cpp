...
bool FeatureInitializer::single_triangulation(Feature* feat, std::unordered_map<size_t,std::unordered_map<f_ts,ClonePose>> &clonesCAM) {
...
bool FeatureInitializer::single_triangulation_1d(Feature* feat, std::unordered_map<size_t,std::unordered_map<f_ts,ClonePose>> &clonesCAM) {
