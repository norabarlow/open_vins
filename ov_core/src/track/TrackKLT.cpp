...
void TrackKLT::feed_monocular(f_ts timestamp, cv::Mat &img, size_t cam_id) {
...
void TrackKLT::feed_stereo(f_ts timestamp, cv::Mat &img_leftin, cv::Mat &img_rightin, size_t cam_id_left, size_t cam_id_right) {
