...
namespace ov_core {
    ...
    public:
         ...
         */
        InertialInitializer(Eigen::Matrix<f_ekf,3,1> gravity, f_ekf window_length, f_ekf imu_excite_threshold) :
         ...
         */
        bool initialize_with_imu(f_ts &time0, Eigen::Matrix<f_ekf,4,1> &q_GtoI0, Eigen::Matrix<f_ekf,3,1> &b_w0,
                                 Eigen::Matrix<f_ekf,3,1> &v_I0inG, Eigen::Matrix<f_ekf,3,1> &b_a0, Eigen::Matrix<f_ekf,3,1> &p_I0inG, bool wait_for_jerk=true);
    ...
    protected:
        ...
        f_ekf _window_length;

        /// Variance threshold on our acceleration to be classified as moving
        f_ekf _imu_excite_threshold;
