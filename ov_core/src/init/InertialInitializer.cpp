...
bool InertialInitializer::initialize_with_imu(float &time0, Eigen::Matrix<float,4,1> &q_GtoI0, Eigen::Matrix<float,3,1> &b_w0,
    ...
    float newesttime = imu_data.at(imu_data.size()-1).timestamp;
