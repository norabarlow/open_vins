...
int main(int argc, char **argv) {
    ...
    f_ts starttime1 = (times_skipped.empty())? f_ts(0) : times_skipped.at(0);
    f_ts endtime1 = (times_skipped.empty())? f_ts(0) : times_skipped.at(times_skipped.size()-1);
    ...
    std::vector<std::vector<f_ts>> timings;
